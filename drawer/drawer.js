...
class Canvas {
    ...
    instantiateShapeFromData(object) {
        ...
        if ("shape" in object && !object.shape.draw) {
            ...
            const borderColor = (_a = s.borderColor) !== null && _a !== void 0 ? _a : "black";
            const backgroundColor = (_b = s.backgroundColor) !== null && _b !== void 0 ? _b : null;
            const id = (_c = s.id) !== null && _c !== void 0 ? _c : null;
            // Circle
...
export function init() {
    ...
    const textAreaDomElm = document.getElementById("textarea");
    const buttonDomElm = document.getElementById("button");
